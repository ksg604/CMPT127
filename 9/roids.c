...
void roid_draw( const roid_t* roid )
{
  ...
  */
	...
	{
		draw_rectangle( 1+roid->x-roid->width/2.0, roid->y-roid->height/2.0,1, roid->y+roid->height/2, roid->color);
	}
	...
	{
		draw_rectangle(0, roid->y-roid->height/2.0,roid->x+roid->width/2.0-1, roid->y+roid->height/2, roid->color);
	}
	if(roid->y+roid->height/2.0 > 1)
	{
		draw_rectangle(roid->x-roid->width/2.0, 0, roid->x+roid->width/2.0, roid->y+roid->height/2-1, roid->color );
	}
}
